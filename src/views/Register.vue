<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <form @submit.prevent="register" class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
      ...
      border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-at-light-green">Register</button>

      <router-link class="txt-sm mt-6 text-center" :to="{name: 'Login'}">
